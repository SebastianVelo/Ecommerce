...
export default {
    page: StyleSheet("flex flex-col", {
        filterbar: StyleSheet("space-y-4 flex flex-col lg:space-y-0 items-start", {
        }),
        main: StyleSheet("h-full w-full py-2", {
            title: StyleSheet("text-xl md:text-3xl text-primary-light px-4 pb-2"),
            paginationWrapper: StyleSheet("flex justify-between flex-col sm:flex-row items-center py-3 w-full", {
